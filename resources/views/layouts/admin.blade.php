    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-mini"><b>4</b>PD</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><font face="Brush Script MT" size="6px">4 Party Delivery</font></b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Sistemas de Informacion "I"</strong>
      </footer>
